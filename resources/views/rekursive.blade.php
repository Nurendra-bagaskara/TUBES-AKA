...
<div class="container mt-5">
    <h1 class="text-center mb-4">Patient Search Recursive</h1>

    <!-- Search Form -->
    <form action="{{ route('search.recursive.process') }}" method="POST" class="mb-4">
        @csrf
    ...
    @if(isset($error_message))
        ...
        {{ $error_message }} dengan waktu {{ number_format($time, 6) }} detik.
        </div>
    @endif
